<?php
/**
 * Contact form markup, rendered via the [dsk_enquiry_form] shortcode
 * (registered in functions.php) so it can be dropped anywhere in the
 * Elementor editor — e.g. via the Shortcode or HTML widget. Deliberately
 * has no outer <section>/heading of its own: Elementor's own
 * section/column and Heading widget supply that.
 *
 * Submits to admin-post.php?action=dsk_enquiry, handled by
 * dsk_handle_enquiry() in functions.php, which emails the address set in
 * Customize → Contact.
 */
