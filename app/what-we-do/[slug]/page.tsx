    ...
    <>
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="relative mx-auto max-w-[1580px] px-6 py-16 text-center lg:px-10 lg:py-[100px]">
          <SectionPill label={page.deliver.pill} variant="red" />
          ...
          <p className="mx-auto mt-8 max-w-[1002px] text-[16px] font-light leading-[30px] text-black lg:text-[18px] lg:leading-[35px]">
            {page.deliver.body}
          </p>
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-10">
            {page.deliver.cards.map((card) => (
              <div
                key={card.title}
                className="w-full max-w-[446px] rounded-[25px] border-[0.5px] border-goal-navy bg-white/5 px-10 py-14 shadow-[3px_3px_10px_0px_rgba(9,30,38,0.25)] backdrop-blur-[2.5px] sm:w-[calc(50%-20px)] lg:w-[calc(33.3%-27px)]"
              >
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-[1580px] px-6 py-16 text-center lg:px-10 lg:py-[100px]">
          <SectionPill label={page.whatYouGet.pill} variant="red" />
          <h2 className="mx-auto mt-8 max-w-[1028px] text-[36px] font-bold capitalize leading-[1.2] text-goal-navy lg:text-[55px]">
            {page.whatYouGet.heading}
          </h2>
          <SectionDivider variant="red" className="mt-8" />
          <p className="mx-auto mt-8 max-w-[1434px] text-[16px] font-light leading-[30px] text-black lg:text-[18px] lg:leading-[35px]">
            {page.whatYouGet.body}
          </p>

          <div className="mt-16 grid gap-x-8 gap-y-14 sm:grid-cols-2 lg:grid-cols-3">
            {page.whatYouGet.items.map((item) => (
              <div key={item.title} className="mx-auto max-w-[397px]">
